...
EXTENSIONS = {
    ...
    "envoy.filters.http.mgw_authz":                     "//source/extensions/filters/http/mgw_authz:config",
    "envoy.filters.http.mgw_pre_authn":                     "//source/extensions/filters/http/mgw_pre_authn:config",
