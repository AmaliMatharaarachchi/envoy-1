...
using ExtAuthzAsyncCallbacks =
    Grpc::AsyncRequestCallbacks<envoy::service::auth_simple::v3::CheckResponse>;
...
private:
  ...
  Grpc::AsyncClient<envoy::service::auth_simple::v3::CheckRequest,
                    envoy::service::auth_simple::v3::CheckResponse>
      async_client_;
