...
constexpr char V2[] = "envoy.service.auth_simple.v2.Authorization.Check";
...
void GrpcSimpleClientImpl::onSuccess(
    std::unique_ptr<envoy::service::auth_simple::v3::CheckResponse>&& response,
    Tracing::Span& span) {
